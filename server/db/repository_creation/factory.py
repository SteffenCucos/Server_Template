...
from db.connection import DatabaseBackend, DatabaseSettings
...
def create_repository(
    *,
    ...
    if settings.backend == DatabaseBackend.MONGO:
        from db.backends.mongo import MongoRepository
    ...
    if settings.backend == DatabaseBackend.POSTGRES:
        from db.backends.postgres import PostgresRepository
    ...
    if settings.backend == DatabaseBackend.SQLITE:
        from db.backends.sqlite import SQLiteRepository
